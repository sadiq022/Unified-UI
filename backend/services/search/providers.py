...
def _get_search_settings() -> dict:
    """Return search settings from environment variables."""
    return {
        "search_provider": os.getenv("SEARCH_PROVIDER", "duckduckgo"),
        "search_url": os.getenv("SEARXNG_INSTANCE", "http://localhost:8080"),
        "search_result_count": os.getenv("SEARCH_RESULT_COUNT", "5"),
        "search_safesearch": os.getenv("SEARCH_SAFESEARCH", "strict"),
        "search_fallback_chain": os.getenv("SEARCH_FALLBACK_CHAIN", "duckduckgo"),
        "brave_api_key": os.getenv("DATA_BRAVE_API_KEY", ""),
        "google_pse_key": os.getenv("GOOGLE_API_KEY", ""),
